...
class CircularGalleryApp {
  ...
  createMedias(items: any[], bend = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600`, text: 'HTH MOMENT' },
      { image: `https://picsum.photos/seed/2/800/600`, text: 'INNOVATION' },
      { image: `https://picsum.photos/seed/3/800/600`, text: 'PROTOTYPE' }
    ];
