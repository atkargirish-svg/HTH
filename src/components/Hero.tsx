    ...
    <section ref={containerRef} className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="font-code text-[10px] font-bold tracking-[0.3em] uppercase">National Level Engineering Spectacle</span>
        </motion.div>
        ...
        >
          The premier 24-hour national hardware hackathon. Engineering the future of Indian innovation through silicon, solder, and spirit.
        </motion.p>
